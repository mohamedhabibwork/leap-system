...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'active', enum: ['trial', 'active', 'expired', 'cancelled'] }),
    (0, class_validator_1.IsEnum)(['trial', 'active', 'expired', 'cancelled']),
...
], CreateSubscriptionDto.prototype, "auto_renew", void 0);
