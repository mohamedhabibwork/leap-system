...
exports.sessionAttendeesRelations = exports.lessonSessionsRelations = exports.enrollmentsRelations = exports.lessonsRelations = exports.courseSectionsRelations = exports.coursesRelations = exports.sessionAttendees = exports.lessonSessions = exports.certificates = exports.courseReviews = exports.quizAnswers = exports.quizAttempts = exports.assignmentSubmissions = exports.lessonProgress = exports.enrollments = exports.quizQuestions = exports.questionOptions = exports.questionBank = exports.quizzes = exports.assignments = exports.courseResources = exports.lessons = exports.courseSections = exports.courses = exports.courseCategories = void 0;
...
exports.lessonSessions = (0, pg_core_1.pgTable)('lesson_sessions', {
    id: (0, pg_core_1.bigserial)('id', { mode: 'number' }).primaryKey(),
    uuid: (0, pg_core_1.uuid)('uuid').defaultRandom().notNull().unique(),
    lessonId: (0, pg_core_1.bigserial)('lesson_id', { mode: 'number' }).references(() => exports.lessons.id).notNull(),
    titleEn: (0, pg_core_1.varchar)('title_en', { length: 255 }).notNull(),
    titleAr: (0, pg_core_1.varchar)('title_ar', { length: 255 }),
    sessionTypeId: (0, pg_core_1.bigserial)('session_type_id', { mode: 'number' }).references(() => lookups_schema_1.lookups.id).notNull(),
    ...
    timezone: (0, pg_core_1.varchar)('timezone', { length: 100 }).default('UTC'),
    meetingUrl: (0, pg_core_1.varchar)('meeting_url', { length: 500 }),
    meetingPassword: (0, pg_core_1.varchar)('meeting_password', { length: 255 }),
    maxAttendees: (0, pg_core_1.integer)('max_attendees'),
    descriptionEn: (0, pg_core_1.text)('description_en'),
    descriptionAr: (0, pg_core_1.text)('description_ar'),
    recordingUrl: (0, pg_core_1.varchar)('recording_url', { length: 500 }),
    statusId: (0, pg_core_1.bigserial)('status_id', { mode: 'number' }).references(() => lookups_schema_1.lookups.id).notNull(),
    attendanceCount: (0, pg_core_1.integer)('attendance_count').default(0),
    isDeleted: (0, pg_core_1.boolean)('isDeleted').default(false).notNull(),
    createdAt: (0, pg_core_1.timestamp)('createdAt', { withTimezone: true }).defaultNow().notNull(),
    updatedAt: (0, pg_core_1.timestamp)('updatedAt', { withTimezone: true }).defaultNow(),
    deletedAt: (0, pg_core_1.timestamp)('deletedAt', { withTimezone: true }),
}, (table) => ({
    uuidIdx: (0, pg_core_1.index)('lesson_sessions_uuid_idx').on(table.uuid),
    lessonIdx: (0, pg_core_1.index)('lesson_sessions_lesson_id_idx').on(table.lessonId),
    statusIdx: (0, pg_core_1.index)('lesson_sessions_status_id_idx').on(table.statusId),
    startTimeIdx: (0, pg_core_1.index)('lesson_sessions_start_time_idx').on(table.startTime),
}));
exports.sessionAttendees = (0, pg_core_1.pgTable)('session_attendees', {
    id: (0, pg_core_1.bigserial)('id', { mode: 'number' }).primaryKey(),
    uuid: (0, pg_core_1.uuid)('uuid').defaultRandom().notNull().unique(),
    sessionId: (0, pg_core_1.bigserial)('session_id', { mode: 'number' }).references(() => exports.lessonSessions.id).notNull(),
    userId: (0, pg_core_1.bigserial)('userId', { mode: 'number' }).references(() => users_schema_1.users.id).notNull(),
    enrollmentId: (0, pg_core_1.bigserial)('enrollment_id', { mode: 'number' }).references(() => exports.enrollments.id).notNull(),
    ...
    uuidIdx: (0, pg_core_1.index)('session_attendees_uuid_idx').on(table.uuid),
    sessionIdx: (0, pg_core_1.index)('session_attendees_session_id_idx').on(table.sessionId),
    userIdx: (0, pg_core_1.index)('session_attendees_userId_idx').on(table.userId),
    enrollmentIdx: (0, pg_core_1.index)('session_attendees_enrollment_id_idx').on(table.enrollmentId),
}));
...
exports.lessonsRelations = (0, drizzle_orm_1.relations)(exports.lessons, ({ one, many }) => ({
    ...
    resources: many(exports.courseResources),
    sessions: many(exports.lessonSessions),
}));
exports.enrollmentsRelations = (0, drizzle_orm_1.relations)(exports.enrollments, ({ one, many }) => ({
    ...
    sessionAttendees: many(exports.sessionAttendees),
}));
exports.lessonSessionsRelations = (0, drizzle_orm_1.relations)(exports.lessonSessions, ({ one, many }) => ({
    lesson: one(exports.lessons, {
        fields: [exports.lessonSessions.lessonId],
        references: [exports.lessons.id],
    }),
    sessionType: one(lookups_schema_1.lookups, {
        fields: [exports.lessonSessions.sessionTypeId],
        references: [lookups_schema_1.lookups.id],
    }),
    status: one(lookups_schema_1.lookups, {
        fields: [exports.lessonSessions.statusId],
        references: [lookups_schema_1.lookups.id],
    }),
    attendees: many(exports.sessionAttendees),
}));
exports.sessionAttendeesRelations = (0, drizzle_orm_1.relations)(exports.sessionAttendees, ({ one }) => ({
    session: one(exports.lessonSessions, {
        fields: [exports.sessionAttendees.sessionId],
        references: [exports.lessonSessions.id],
    }),
    user: one(users_schema_1.users, {
        fields: [exports.sessionAttendees.userId],
        references: [users_schema_1.users.id],
    }),
    enrollment: one(exports.enrollments, {
        fields: [exports.sessionAttendees.enrollmentId],
        references: [exports.enrollments.id],
    }),
    attendanceStatus: one(lookups_schema_1.lookups, {
        fields: [exports.sessionAttendees.attendanceStatusId],
        references: [lookups_schema_1.lookups.id],
    }),
}));
