                ...
                <ResponsiveContainer width="100%" height={300}>
                  <PieChart>
                    <Pie
                      ...
                      dataKey="value"
                    >
                      {courseEnrollmentData.map((entry: any, index: number) => (
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {[
                    { name: 'Complete Web Development Bootcamp', enrollments: 425 },
                    { name: 'Data Science with Python', enrollments: 312 },
                    { name: 'React Native Mobile Development', enrollments: 198 },
                    { name: 'AWS Cloud Practitioner', enrollments: 156 },
                    { name: 'UI/UX Design Masterclass', enrollments: 143 },
                  ].map((course, index) => (
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">+123 this month</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
