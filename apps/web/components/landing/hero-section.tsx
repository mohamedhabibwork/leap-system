...
export function HeroSection() {
  ...
  return (
    <div className="relative bg-gradient-to-br from-blue-50 via-background to-purple-50 dark:from-blue-950/20 dark:via-background dark:to-purple-950/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
        <div className="text-center space-y-8">
          ...
          {/* Headline */}
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-foreground tracking-tight">
            {t('headline')}
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 text-sm text-muted-foreground">
            <div className="flex items-center gap-2">
              ...
              <span><strong className="text-foreground">50,000</strong>{t('socialProof.learners', { count: '50,000' })}</span>
            </div>
            <div className="flex items-center gap-2">
              <BookOpen className="h-5 w-5 text-purple-600 dark:text-purple-400" />
              <span><strong className="text-foreground">1,000</strong>{t('socialProof.courses', { count: '1,000' })}</span>
            </div>
            <div className="flex items-center gap-2">
              <PlayCircle className="h-5 w-5 text-green-600 dark:text-green-400" />
              <span><strong className="text-foreground">100,000</strong>{t('socialProof.lessons', { count: '100,000' })}</span>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            <Link
              href="/hub/courses"
              className="inline-flex items-center px-8 py-4 border-2 border-border text-lg font-semibold rounded-lg text-foreground bg-background hover:bg-muted hover:border-border/80 transition-all duration-200"
            >
