...
CREATE TABLE IF NOT EXISTS "user_profiles" (
	...
	"updatedAt" timestamp with time zone DEFAULT now(),
	"deletedAt" timestamp with time zone,
	CONSTRAINT "user_profiles_uuid_unique" UNIQUE("uuid"),
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "story_views" ADD CONSTRAINT "story_views_userId_users_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "users_current_subscription_id_idx" ON "users" USING btree ("current_subscription_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "user_profiles_uuid_idx" ON "user_profiles" USING btree ("uuid");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "enrollments_enrollment_type_idx" ON "enrollments" USING btree ("enrollment_type");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "quizzes_lesson_id_idx" ON "quizzes" USING btree ("lesson_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "story_views_userId_idx" ON "story_views" USING btree ("userId");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "story_views_story_user_unique_idx" ON "story_views" USING btree ("story_id","userId");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "user_notification_preferences_user_id_idx" ON "user_notification_preferences" USING btree ("user_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "sessions_user_active_idx" ON "sessions" USING btree ("user_id","is_active");--> statement-breakpoint
